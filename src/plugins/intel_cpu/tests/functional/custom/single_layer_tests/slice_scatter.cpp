...
typedef std::tuple<SliceScatterSpecificParams,       // SliceScatter specific parameters
...
public:
    static std::string getTestCaseName(testing::TestParamInfo<SliceScatterLayerTestCPUParam> obj) {
        ...
        std::tie(params, secondaryInputType, netPrecision, cpuParams) = obj.param;
...
protected:
    ...
    void SetUp() override {
        ...
        ElementType netPrecision;
        CPUSpecificParams cpuParams;
        std::tie(sliceParams, secondaryInputType, netPrecision, cpuParams) = this->GetParam();
        shapes = sliceParams.shapes;
        ...
        if (secondaryInputType == ov::test::utils::InputLayerType::PARAMETER) {
            // SliceScatter updates, start, stop, step, axes are parameters.
            ...
            params.push_back(std::dynamic_pointer_cast<ov::op::v0::Parameter>(stopNode));
            ...
            if (!sliceParams.axes.empty()) {
                ...
                sliceNode =
                    std::make_shared<ov::op::v15::SliceScatter>(params[0], params[1], startNode, stopNode, stepNode);
            }
...
const std::vector<SliceScatterSpecificParams> paramsPlain2DStatic = {
    SliceScatterSpecificParams{static_shapes_to_test_representation({{32, 20}, {16, 6}}),
                               {0, 10},
                               {16, 16},
                               {1, 1},
                               {0, 1}},
    SliceScatterSpecificParams{static_shapes_to_test_representation({{32, 20}, {14, 3}}), {2, 5}, {16, 8}, {1, 1}, {}},
    SliceScatterSpecificParams{static_shapes_to_test_representation({{32, 20}, {14, 6}}),
                               {2, 5},
                               {16, 16},
                               {1, 2},
                               {0, 1}},
    SliceScatterSpecificParams{static_shapes_to_test_representation({{32, 20}, {8, 16}}),
                               {0, 0},
                               {16, 16},
                               {1, 2},
                               {1, 0}},
    SliceScatterSpecificParams{static_shapes_to_test_representation({{32, 20}, {8, 20}}), {0}, {16}, {2}, {0}},
    SliceScatterSpecificParams{static_shapes_to_test_representation({{32, 20}, {32, 16}}), {0}, {16}, {1}, {1}}};

const std::vector<SliceScatterSpecificParams> paramsPlain2DDynamic = {
    SliceScatterSpecificParams{
        {
            {{{-1, -1}, {{32, 20}, {16, 16}, {24, 16}}}, {{-1, -1}, {{16, 6}, {16, 6}, {16, 6}}}},
        },
        {0, 10},
        {16, 16},
        {1, 1},
        {0, 1}},
    SliceScatterSpecificParams{{
                                   {{{-1, 16}, {{16, 16}, {20, 16}, {32, 16}}}, {{-1, 3}, {{14, 3}, {14, 3}, {14, 3}}}},
                               },
                               {2, 5},
                               {16, 8},
                               {1, 1},
                               {}},
    SliceScatterSpecificParams{{{{{{{16, 32}, {16, 32}}}, {{16, 32}, {32, 16}, {24, 24}}},
                                 {{{{14, 32}, {3, 8}}}, {{14, 6}, {14, 6}, {14, 6}}}}},
                               {2, 5},
                               {16, 16},
                               {1, 2},
                               {0, 1}},
    SliceScatterSpecificParams{
        {
            {{{-1, -1}, {{32, 20}, {16, 16}, {24, 16}}}, {{-1, -1}, {{8, 16}, {8, 16}, {8, 16}}}},
        },
        {0, 0},
        {16, 16},
        {1, 2},
    ...
    SliceScatterSpecificParams{
        {
            {{{-1, 16}, {{16, 16}, {20, 16}, {32, 16}}}, {{-1, 16}, {{8, 16}, {8, 16}, {8, 16}}}},
        },
        {0},
        {16},
        {2},
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_Plain_Static_2D,
                         ...
                         ::testing::Combine(::testing::ValuesIn(paramsPlain2DStatic),
...
INSTANTIATE_TEST_SUITE_P(smoke_CompareWithRefs_Plain_Dynamic_2D,
                         SliceScatterLayerCPUTest,
                         ::testing::Combine(::testing::ValuesIn(paramsPlain2DDynamic),
                                            ::testing::Values(ov::test::utils::InputLayerType::CONSTANT),
                                            ::testing::ValuesIn(inputPrecisions),
                                            ::testing::Values(emptyCPUSpec)),
                         SliceScatterLayerCPUTest::getTestCaseName);
...
//     SliceScatterSpecificParams{{0, 2, 5, 4}, {1, 4, 28, 27}, {1, 1, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, 1, 0, 0}, {20, 3, 32, 1}, {1, 1, 1, 1}, {3, 1, 2, 0}},
//     SliceScatterSpecificParams{{0, 0, 10, 0}, {1, 3, 20, 20}, {1, 1, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, 0, 20, 20}, {1, 5, 26, 25}, {1, 1, 2, 1}, {0, 1, 3, 2}},
//     SliceScatterSpecificParams{{0, 0, 0, 20}, {1, 2, 30, 30}, {1, 1, 2, 1}, {}},
//     SliceScatterSpecificParams{{0, 0, 2, 10}, {1, 3, 32, 20}, {1, 1, 1, 1}, {0, 1, 2, 3}},
//     SliceScatterSpecificParams{{0, 1, 0, 10}, {1, 5, 32, 30}, {1, 1, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, 1, 2, 10}, {1, 5, 32, 18}, {1, 1, 1, 2}, {0, 1, 2, 3}},
//     SliceScatterSpecificParams{{0, 0, 2, 10}, {1, 8, 32, 18}, {1, 2, 1, 2}, {}},
//     SliceScatterSpecificParams{{0, 0, 10}, {2, 32, 18}, {1, 1, 1}, {1, 2, 3}},
//     SliceScatterSpecificParams{{0, 10}, {2, 32}, {1, 1}, {1, 3}}};
...
// const std::vector<SliceScatterSpecificParams> testCasesBlocked4DSubset1 = {
//     SliceScatterSpecificParams{{0, 0, 0, 0}, {1, 32, 32, 32}, {1, 1, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, 0, 16, 0}, {1, 32, 32, 32}, {1, 1, 1, 1}, {0, 3, 2, 1}},
//     SliceScatterSpecificParams{{0, 0, 0}, {32, 32, 16}, {1, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, 0, 0}, {16, 32, 32}, {1, 1, 1}, {1, 3, 2}},
// };

// const std::vector<SliceScatterSpecificParams> testCasesBlocked4DSubset2 = {
//     SliceScatterSpecificParams{{0, 0, 5, 4}, {1, 16, 28, 27}, {1, 1, 1, 1}, {0, 1, 2, 3}},
//     SliceScatterSpecificParams{{0, 16, 0, 0}, {1, 32, 10, 10}, {1, 1, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, 0, 10, 0}, {16, 1, 20, 10}, {1, 1, 1, 1}, {1, 0, 2, 3}},
//     SliceScatterSpecificParams{{0, 0, 20, 20}, {1, 32, 25, 25}, {1, 1, 1, 1}, {0, 1, 3, 2}},
//     SliceScatterSpecificParams{{0, 16, 0, 20}, {32, 32, 1, 30}, {1, 1, 1, 2}, {2, 1, 0, 3}},
//     SliceScatterSpecificParams{{0, 16, 2, 10}, {1, 32, 32, 20}, {1, 1, 2, 1}, {0, 1, 2, 3}},
//     SliceScatterSpecificParams{{0, 16, 0, 0}, {2, 64, 32, 20}, {1, 1, 1, 1}, {0, 1, 2, 3}},
//     SliceScatterSpecificParams{{0, 32, 0, 0}, {2, 50, 32, 20}, {1, 1, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, 0, 0, 0}, {32, 12, 2, 20}, {1, 1, 1, 1}, {0, 3, 2, 1}},
//     SliceScatterSpecificParams{{0, -16, 0, 10}, {2, 100, 32, 20}, {1, 1, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, -16, 0, 0}, {2, -4, 32, 20}, {1, 1, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, -32, 0, 0}, {2, -12, 32, 20}, {1, 1, 1, 1}, {}}};
...
//     SliceScatterSpecificParams{{0, 2, 0, 5, 4}, {1, 4, 5, 28, 27}, {1, 1, 1, 1, 1}, {0, 1, 2, 3, 4}},
//     SliceScatterSpecificParams{{0, 0, 10, 0, 0}, {1, 5, 20, 32, 20}, {1, 1, 1, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, 1, 10, 0, 0}, {20, 3, 20, 32, 1}, {1, 1, 1, 1, 1}, {4, 1, 2, 3, 0}},
//     SliceScatterSpecificParams{{0, 20, 0, 0, 20}, {1, 30, 20, 5, 26}, {1, 1, 1, 2, 2}, {0, 3, 2, 1, 4}},
//     SliceScatterSpecificParams{{0, 0, 10, 0, 20}, {1, 2, 20, 30, 30}, {1, 1, 2, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, 0, 2, 10, 0}, {1, 5, 10, 32, 20}, {1, 1, 1, 1, 1}, {0, 1, 2, 3, 4}},
//     SliceScatterSpecificParams{{0, 1, 0, 10, 0}, {1, 5, 20, 32, 32}, {1, 1, 1, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, 0, 0, 0, 0}, {1, 5, 10, 16, 16}, {1, 1, 2, 1, 1}, {0, 1, 2, 3, 4}}};
...
// const std::vector<SliceScatterSpecificParams> testCasesBlocked5DSubset1 = {
//     SliceScatterSpecificParams{{0, 0, 0, 5, 4}, {1, 16, 5, 28, 27}, {1, 1, 1, 1, 1}, {0, 1, 2, 3, 4}},
//     SliceScatterSpecificParams{{0, 0, 10, 0, 0}, {1, 16, 20, 32, 20}, {1, 1, 1, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, 0, 0, 20, 20}, {16, 1, 20, 26, 30}, {1, 1, 1, 2, 2}, {1, 0, 2, 4, 3}},
//     SliceScatterSpecificParams{{0, 0, 10, 0, 20}, {1, 16, 20, 30, 30}, {1, 1, 2, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, 0, 2, 10, 0}, {1, 16, 10, 32, 20}, {1, 1, 1, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, 0, 0, 10, 0}, {1, 8, 20, 32, 32}, {1, 1, 1, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, 0, 0, 0, 0}, {1, 16, 10, 16, 16}, {1, 1, 2, 1, 1}, {0, 1, 2, 3, 4}},
// };

// const std::vector<SliceScatterSpecificParams> testCasesBlocked5DSubset2 = {
//     SliceScatterSpecificParams{{0, 0, 0, 5, 4}, {1, 16, 5, 28, 27}, {1, 1, 1, 1, 1}, {0, 1, 2, 3, 4}},
//     SliceScatterSpecificParams{{0, 0, 5, 4}, {16, 5, 28, 27}, {1, 1, 1, 1}, {1, 2, 3, 4}},
//     SliceScatterSpecificParams{{0, 0, 10, 0, 0}, {1, 16, 20, 32, 20}, {1, 1, 1, 1, 1}, {0, 1, 2, 3, 4}},
//     SliceScatterSpecificParams{{0, 0, 0, 20, 20}, {1, 20, 16, 30, 26}, {1, 1, 1, 2, 2}, {0, 2, 1, 3, 4}},
//     SliceScatterSpecificParams{{0, 0, 10, 0, 20}, {1, 16, 20, 30, 30}, {1, 1, 2, 1, 1}, {0, 1, 2, 3, 4}},
//     SliceScatterSpecificParams{{0, 0, 2, 10, 0}, {1, 16, 10, 32, 20}, {1, 1, 1, 1, 1}, {0, 1, 2, 3, 4}},
//     SliceScatterSpecificParams{{0, 0, 0, 10, 0}, {1, 8, 20, 32, 32}, {1, 1, 1, 1, 1}, {0, 1, 2, 3, 4}},
//     SliceScatterSpecificParams{{0, 0, 0, 0, 0}, {10, 16, 1, 16, 16}, {2, 1, 1, 1, 1}, {2, 1, 0, 3, 4}},
//     SliceScatterSpecificParams{{0, 0, 0, 0, 0}, {1, 25, 20, 10, 10}, {1, 1, 1, 1, 1}, {}},
//     SliceScatterSpecificParams{{0, 16, 0, 0, 0}, {1, 25, 20, 10, 10}, {1, 1, 1, 1, 1}, {0, 1, 2, 3, 4}},
//     SliceScatterSpecificParams{{0, 16, 0, 0, 0}, {1, 64, 20, 10, 10}, {1, 1, 1, 1, 1}, {0, 1, 2, 3, 4}},
// };
...
class SliceScatterLayerDescriptorCPUTest : public SliceScatterLayerCPUTest {};

TEST_P(SliceScatterLayerDescriptorCPUTest, DescriptorsCheck) {
    SKIP_IF_CURRENT_TEST_IS_DISABLED()

    ASSERT_THROW(compile_model(), ov::Exception);
}

// const std::vector<SliceScatterSpecificParams> testCasesDescriptors = {
//     SliceScatterSpecificParams{{0, -4, 0, 0}, {0, 2147483647, 0, 0}, {1, 1, 1, 1}, {0, 1, 2, 3}},
//     SliceScatterSpecificParams{{0, 5, 0, 0}, {1, 20, 28, 27}, {1, 1, 1, 1}, {0, 1, 2, 3}},
//     SliceScatterSpecificParams{{0, 0, 0, 0}, {1, 2147483647, 32, 32}, {1, 2, 1, 1}, {0, 1, 2, 3}}};
...
// INSTANTIATE_TEST_SUITE_P(smoke_SliceScatterLayerDescriptorCPUTest,
//                          SliceScatterLayerDescriptorCPUTest,
...
//                          SliceScatterLayerDescriptorCPUTest::getTestCaseName);
